 ...
 * @author Mastadon
 */
public class FXMLSubWalletTransactionsViewController implements Initializable {
    ...
    @FXML
    private TableColumn<TransactionItem, Double> amount;
    @FXML
    ...
    @FXML
    private TableColumn<TransactionItem, String> smartBridge;
    /**
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tid.setCellFactory(new FXMLSubWalletTransactionsViewController.HyperlinkCell());
        
        amount.setCellValueFactory(new PropertyValueFactory<TransactionItem, Double>("amount"));
        amount.setCellFactory(new FXMLSubWalletTransactionsViewController.ColumnFormatter<TransactionItem, Double>());

        fee.setCellValueFactory(new PropertyValueFactory<TransactionItem, Double>("fee"));
        fee.setCellFactory(new FXMLSubWalletTransactionsViewController.ColumnFormatter<TransactionItem, Double>());

        from.setCellValueFactory(new PropertyValueFactory<TransactionItem, Hyperlink>("from_link"));
        from.setCellFactory(new FXMLSubWalletTransactionsViewController.HyperlinkCell());

        to.setCellValueFactory(new PropertyValueFactory<TransactionItem, Hyperlink>("to_link"));
        to.setCellFactory(new FXMLSubWalletTransactionsViewController.HyperlinkCell());
        
        smartBridge.setCellValueFactory(new PropertyValueFactory<TransactionItem, String>("smartBridge"));
        smartBridge.setCellFactory(new FXMLSubWalletTransactionsViewController.ColumnFormatter<TransactionItem, String>());
